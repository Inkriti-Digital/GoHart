			...
			<section class="page-content planner">
				<div class="content-block content-body">
					<div class="bottom-rule">
						<div class="cta"><span>PARK + RIDE = PEACE</span><hr/></div>
					</div>
					<div class="info">
						<h2>HOW TO PARK-N-RIDE</h2>
					...
					<div>
						<p>Whether you’re in FishHawk or New Tampa, or somewhere in between, there’s a Park-n-Ride location that’s convenient for you, and each lot is well lit for your safety. Use the ride to catch up on paperwork, check your email on your smartphone or read the paper—you’ll arrive at work calm, refreshed and ready to face the day!</p>
