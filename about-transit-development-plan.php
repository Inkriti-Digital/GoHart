	...
	<body>
		...
		<div class="container services">
			...
			<section class="header">
				...
				<div class="headline transit-development-plan-headline">
					<h1>TRANSIT</h1>
					<br/>
			...
			<section class="page-content">
				<div class="content-block">
					...
					<div class="bottom-rule">
						<div class="cta"><span>TDP UPDATE</span><hr/></div>
					</div>
					<div class="content-body">
						
						<div class="fullColumnWidth brick-list">
							<div class="half-column brick-column left">
								The Transit Development Plan (TDP) is required of each transit agency receiving state funding from the Florida Department of Transportation.
							</div>
