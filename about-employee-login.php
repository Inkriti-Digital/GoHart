			...
			<section class="page-content">
				<div class="content-block">
					...
					<div class="bottom-rule">
						<div class="cta"><span>HART WEB E-MAIL</span><hr/></div>
					</div>
					<div class="content-body">
						...
						<div class="employee-terms-of-use">
							CLICK HERE FOR EMPLOYEE TERMS OF USE
						</div>
						<div class="employee-terms-active-img">
							<img src="img/bottom-arrow.png" />
						</div>
						<div class="employee-terms-of-use-desc">
							<h2>HILLSBOROUGH AREA REGIONAL TRANSIT AUTHORITY E-MAIL</h2>
							<p>
						...
						<div class="employee-login">
							<div class="employee-login-form">
								<form action="#">
									...
									<div class="clear-fix"></div>
									<div class="submit-btn"><input type="submit" value="LOGIN"></div>
								</form>
							</div>
						</div>
