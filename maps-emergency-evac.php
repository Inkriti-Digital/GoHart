		...
		<div class="container alerts-detours emergency">
			...
			<section class="page-content planner">
				<div class="content-block content-body">
					...
					<div class="bottom-rule">
						<div class="cta"><span>HART PROVIDES EMERGENCY EVACUATION BUS SERVICES DURING A STORM</span><hr/></div>
					</div>
					...
					<div class="half-column">
						...
						<ul>
							<li><img src="img/locations/locaiton-ico.png"/><b>Sgt. Smith Middle School</b>, 14303 Citrus 
								Pointe Drive in the Citrus Park area (Routes D and I)
							</li>
							<li><img src="img/locations/locaiton-ico.png"/><b>Pizzo Elementary School</b>,  on Bull Run and Fowler in Tampa (Routes A, B, F, J)
							</li>
							<li><img src="img/locations/locaiton-ico.png"/><b>Middleton High School</b> on Osborne and 22nd Street in Tampa(Route E, G, H)
							</li>
							<li><img src="img/locations/locaiton-ico.png"/><b>Doby Elementary School</b> (Route C) in Apollo Beach
							</li>
						</ul>
