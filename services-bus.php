	...
	<body>
		...
		<div class="container services">
			...
			<section class="page-content">
				<div class="content-block">
					...
					<div class="bottom-rule">
						<div class="cta"><span>BUS</span><hr/></div>
					</div>
			...
			<section class="mid-section">
				<div class="mid-copy">
					<h3>Whether you are a resident or out-of-town guest, HART routes connect you with the Bay area’s best destinations.</h3>
				</div>
			</section>
			...
			<section class="page-content" style="background: none;">
				<div class="content-block">
					<div class="bottom-rule">
						<div class="cta"><span>IN-TOWN TROLLEY</span><hr/></div>
					</div>
