			...
			<section class="page-content planner">
				<div class="content-block content-body">
					<div class="info">
						...
						<div>
							<p class="alert-detail">Current bus detours and special alerts on conditions affecting the HART system appear below. Please subscribe to our RSS feed to stay informed of alerts and detours as they happen. Short-term detours (lasting less than two weeks) are not posted on the website.</p>
						</div>
					</div>
