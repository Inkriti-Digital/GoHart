	...
	<body>
		...
		<div class="container services">
			...
			<section class="page-content">
				<div class="content-block">
					...
					<div class="content-body">
						...
						<div class="fullColumnWidth">
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">MONDAY, MAY 4, 2015</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Regular Board of Directors Meeting
										</div>
										<div class="info-row-desc">
											9:00 AM
											<br/>
											HART Administrative Office
											<br/>
							...
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">MONDAY, JUNE 1, 2015</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Regular Board of Directors Meeting
										</div>
							...
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">MONDAY, AUG. 3, 2015</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Regular Board of Directors Meeting
										</div>
							...
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">TBD</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART First Public Hearing on the Tentative FY2016 Milage Rate and Annual Budget; and Regular Board of Directors Meeting
										</div>
										<div class="info-row-desc">
											HART Administrative Office
											<br/>
							...
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									...
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Second and Final Public Hearing on the FY2016 Milage Rate and Annual Budget; and Regular Board of Directors Meeting
										</div>
										<div class="info-row-desc">
											HART Administrative Office
											<br/>
							...
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">MONDAY, NOV. 2, 2015</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Regular Board of Directors Meeting
										</div>
							...
							<div class="three-column-info-chunks"></div>
							<div class="three-column-info-chunks">
								<div class="info-chunk-with-cross-lines">
									<div class="info-row info-title"><span class="info-title-text">MONDAY, DEC. 7, 2015</span></div>
									<div class="info-row last-info-row">
										<div class="info-row-head">
											HART Regular Board of Directors Meeting
										</div>
				...
				<div class="content-block">
					<div class="bottom-rule">
						<div class="cta"><span>BOARD PACKETS</span><hr/></div>
					</div>
					<div class="content-body">
						<p>
							Handouts including the agenda, reports and more are typically given to attendees at HART meetings. If you were not able to make it to the meeting, you can download the packet below in PDF format.
						</p>
						
						<div class="fullColumnWidth brick-list-packets">
