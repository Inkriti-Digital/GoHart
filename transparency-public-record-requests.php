		...
		<div class="container services">
				...
				<div class="content-block">
					...
					<div class="content-body">
						...
						<div class="fullColumnWidth">	
							...
							<p class="point-no-area"><span class="point-no">1</span></p>
						...
						<div class="fullColumnWidth">
							<div class="half-column brick-column left">
								<div class="fullColumnWidth">	
									<p class="point-no-area"><span class="point-no">2</span></p>
									<p class="point-description">
							...
							<div class="half-column brick-column brick-column-last right">
								<div class="fullColumnWidth">	
									<p class="point-no-area"><span class="point-no">3</span></p>
									<p class="point-description">
			...
			<section class="page-content" style="background: none;">
				<div class="content-block">
					<div class="content-body">
						<div class="fullColumnWidth">
							<p class="point-no-area"><span class="point-no">4</span></p>
							<p class="point-description">
						...
						<div>
							<div>
								<div class="half-column brick-column left">
									...
									<div class="fullColumnWidth">	
										<p class="point-no-area"><span class="point-no">5</span></p>
										<p class="point-description">
								...
								<div class="half-column brick-column-last right">
									<div class="fullColumnWidth">	
										<p class="point-no-area"><span class="point-no">6</span></p>
										<p class="point-description">
									...
									<div class="fullColumnWidth">	
										<p class="point-no-area"><span class="point-no">7</span></p>
										<p class="point-description">
									...
									<div class="fullColumnWidth">	
										<p class="point-no-area"><span class="point-no">8</span></p>
										<p class="point-description">
									...
									<div class="fullColumnWidth">	
										<p class="point-no-area"><span class="point-no">9</span></p>
										<p class="point-description">
