					...
					<div class="content-body">
						...
						<div class="tix-box">
								<div class="tix-row">
									...
									<div class="tix-fare">$95.00</div>
								</div>
								<div class="tix-row blue-row">
									<div class="tix-type">LOCAL</div>
									<div class="tix-fare">$65.00<img src="img/fares/tix-ico-white.png"/></div>
								</div>
								<div class="tix-row">
									<div class="tix-type">LOCAL SENIOR/DISABLED/MEDICARE/YOUTH</div>
									<div class="tix-fare">$32.50</div>
								</div>
												
							<div class="disclaimer">*You must show proper HART or PSTA I.D. to the bus operator to use a discounted pass.</div>
							
						</div>
						<div class="half-column">
								<ul>
									<li><img src="img/locations/locaiton-ico.png"/>Good from the first through the last day of the month issued.</li>
									<li><img src="img/locations/locaiton-ico.png"/>Express Pass good on all routes, every day</li>
									<li><img src="img/locations/locaiton-ico.png"/>Local Pass good on all local routes</li>
							</div>
							<div class="half-column">
								<ul>
									<li><img src="img/locations/locaiton-ico.png"/>All HART Farecards (1-Day, 3-Day, 31-Day) will be accepted on the streetcar</li>
									<li><img src="img/locations/locaiton-ico.png"/>Valid on all HART In-Town Trolleys</li>
							</div>
